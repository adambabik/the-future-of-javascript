...
function Range(start) {
  var end = arguments[1] !== (void 0) ? arguments[1] : Infinity;
...
Range.prototype.step = function(step) {
  ...
  return ($__0 = {}, Object.defineProperty($__0, Symbol.iterator, {
    value: $traceurRuntime.initGeneratorFunction(function $__7() {
      return $traceurRuntime.createGeneratorInstance(function($ctx) {
        while (true)
          switch ($ctx.state) {
            case 0:
              $ctx.state = (val <= end) ? 1 : -2;
              break;
            case 1:
              $ctx.state = 2;
              return val;
...
for (var $__1 = Range(-5, 5)[Symbol.iterator](),
...
for (var $__3 = new Range(1, 10).step(2)[Symbol.iterator](),
...
for (var $__5 = new Range(1).step(3)[Symbol.iterator](),
